...
public class DriverJoystick extends XboxController1038 {
    ...
    private DriverJoystick() {
         ...
         */
        this.yButton.whileTrue(driveTrain.sysIdQuasistatic(SysIdRoutine.Direction.kForward));
        this.aButton.whileTrue(driveTrain.sysIdQuasistatic(SysIdRoutine.Direction.kReverse));
        this.bButton.whileTrue(driveTrain.sysIdDynamic(SysIdRoutine.Direction.kForward));
        this.xButton.whileTrue(driveTrain.sysIdDynamic(SysIdRoutine.Direction.kReverse));
    }
    ...
    public void setAValue(double newA) {
        this.a = newA;
    }
    ...
    private double getSidewaysValue() {
        ...
        double sideways = limitRate(highGainNearCenter, prevSideways, sidewaysLimiter);
    ...
    private double getForwardValue() {
        ...
        double forward = limitRate(highGainNearCenter, prevForward, forwardLimiter);
        prevForward = forward;
    ...
    private double getRotateValue() {
        ...
        double rotate = limitRate(highGainNearCenter, prevRotate, rotateLimiter);
        prevRotate = rotate;
