...
public enum DriveWaypoints {
    ...
    Level2LeftCoral19(new Pose2d(new Translation2d(3.8, 5.15), new Rotation2d(Math.toRadians(120.0)))),
    RightCoral19(new Pose2d(new Translation2d(3.704, 5.062), new Rotation2d(-60.0))),
    Level2RightCoral19(new Pose2d(new Translation2d(3.53, 5.1), new Rotation2d(Math.toRadians(120.0)))),
    LeftCoral20(new Pose2d(new Translation2d(5.299, 5.074), new Rotation2d(-120.0))),
    Level2LeftCoral20(new Pose2d(new Translation2d(5.25, 5.307), new Rotation2d(60.0))),
    RightCoral20(new Pose2d(new Translation2d(4.975, 5.206), new Rotation2d(-120.0))),
    Level2RightCoral20(new Pose2d(new Translation2d(4.98, 5.43), new Rotation2d(Math.toDegrees(60.0)))),
    LeftCoral21(new Pose2d(new Translation2d(5.826, 3.875), new Rotation2d(180.000))),
    Level2LeftCoral21(new Pose2d(new Translation2d(5.89, 4.22), new Rotation2d(0.0))),
