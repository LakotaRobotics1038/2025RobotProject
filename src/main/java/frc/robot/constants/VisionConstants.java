...
public final class VisionConstants {
    ...
    public static final Transform3d kRobotToCamFront = new Transform3d(new Translation3d(0.1, 0.0, 0.1),
            new Rotation3d(0, 0, 0));
    public static final Transform3d kRobotToCamBack = new Transform3d(new Translation3d(0.1, 0.0, 0.1),
            new Rotation3d(0, 0, 0));
