...
public class MakeDetermineWaypointCommand extends Command {
    ...
    public void initialize() {
        ...
        switch (setpointLevel) {
            ...
            case L2Coral:
                ...
                break;
            case L23Algae:
                getLevel23AlgaeWaypoint(scoringSide);
                break;
            case L34Algae:
                getLevel34AlgaeWaypoint(scoringSide);
                break;
            case Processor:
    ...
    private void getLevel23AlgaeWaypoint(ScoringSide scoringSide) {
        switch (this.bestId) {
            case 6:
    ...
    private void getLevel34AlgaeWaypoint(ScoringSide scoringSide) {
        switch (this.bestId) {
            case 6:
