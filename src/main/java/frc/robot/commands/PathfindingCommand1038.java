...
public class PathfindingCommand1038 extends Command {
    ...
    public void initialize() {
        ...
        if (currentPose.getTranslation().getDistance(targetPose.getTranslation()) < 0) {
    ...
    public static Command warmupCommand() {
        return new PathfindingCommand1038(
